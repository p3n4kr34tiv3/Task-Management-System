    ...
    <div className="h-screen w-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-y-auto fixed inset-0">
      ...
      <section className="container mx-auto px-6 py-24 text-center relative">
        ...
        >
          ...
          >
            Experience the future of task management with our intuitive, powerful platform. 
            <br className="hidden md:block" />
            Stay organized, boost productivity, and achieve your goals with elegant simplicity.
          </motion.p>
          ...
          {[
            {
              ...
              description: 'Organize tasks with intelligent priority levels and visual boards that adapt to your workflow.',
            ...
            },
            {
              ...
              description: 'Work together with your team in real-time with advanced assignment and tracking features.',
            ...
            },
            {
              ...
              description: 'Get insights into productivity patterns with beautiful charts and progress tracking.',
            ...
            },
            {
              ...
              description: 'AI-powered deadline management with intelligent reminders and time optimization.',
            ...
            },
            {
              ...
              description: 'Experience blazing fast task management with optimized performance and instant updates.',
            ...
            },
            {
              ...
              description: 'Bank-level security with end-to-end encryption and comprehensive data protection.',
      ...
      <section className="container mx-auto px-6 py-24 relative">
        ...
        <div className="text-center mb-20 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Don't just take our word for it. See what industry leaders have to say about Cleaner.
            </p>
          </motion.div>
        </div>
          ...
          {[
            {
              ...
              avatar: "S",
              gradient: "from-blue-500 to-cyan-500",
              quote: "Cleaner has revolutionized our project management. The intuitive priority boards and seamless collaboration features have increased our team's productivity by 40%!",
              company: "🚀 TechCorp"
            },
            {
              name: "Mike Rodriguez",
              ...
              avatar: "M",
              gradient: "from-green-500 to-emerald-500",
              quote: "Finally, a task manager that doesn't overcomplicate things! Clean design, powerful features, and lightning-fast performance. It's everything our dev team needed.",
              company: "✨ StartupX"
            },
            {
              name: "Alex Thompson",
              ...
              quote: "The attention to detail in Cleaner's UI/UX is exceptional. It's not just functional—it's genuinely enjoyable to use. Our design team is obsessed!",
              company: "🎨 CreativeHub"
            }
            ...
            >
              <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl h-full relative overflow-hidden group">
                ...
                {/* Quote decoration */}
                <div className="absolute top-6 right-6 text-6xl text-gray-200 dark:text-gray-700 opacity-50 font-serif">“</div>
                ...
                <CardContent className="pt-8 pb-6 relative z-10">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-500 dark:text-gray-500 text-xs mt-1">{testimonial.company}</p>
                    </div>
                  </div>
                </CardContent>
        ...
        <Card className="border-0 shadow-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="py-16 text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of teams already using Cleaner to boost their productivity.
            </p>
      ...
      <footer className="container mx-auto px-6 py-12 border-t border-gray-200 dark:border-gray-700">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Built by Siddhartha with ❤️ • 
            © 2024 Cleaner Task Management
          </p>
        </div>
      </footer>
    </div>
